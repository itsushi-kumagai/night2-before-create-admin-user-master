...
<section id="header-container">
    ...
    <div class="information">
        ...
        @else
        <span style="float: right; margin-top: 1rem;" ><a href="{{ route('prompt.show') }}">Login to add comment</a></span>
        <comments-component :post="{{ $posts['particular_post'] }}"></comments-component>
        @endif
    </div>
</div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="image">
                    <a href="{{ route('posts.show', $recommended_post->id) }}">
                        <img src="{{ asset('storage/'.$recommended_post->image) }}" alt="" width="100%" height="auto">
                    </a>
                </div>
            ...
            <div class="name-button">
                <div class="event-name">
                    <a href="{{ route('posts.show', $recommended_post->id) }}">
                        {{ str_limit($recommended_post->title, 20) }}
                    </a>
                </div>
            </div>
            <div class="heart-button">
                    ...
                    @else
                        <button class="heart"><a href="{{ route('prompt.show') }}"><i class="fas fa-heart fa-2x" style="color: white;"></i></a></button>
                    @endif
            </div>
            <div class="event-date">
                ...
                <div class="card-info">
                    <p>{{ str_limit($recommended_post->description, 40) }}
                        <a href="{{ route('posts.show', $recommended_post->id) }}" style="color: white">...see more</a>
                    </p>
                </div>
            </div>    
        </div>
